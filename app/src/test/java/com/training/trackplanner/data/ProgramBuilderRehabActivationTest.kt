...
private class RehabProgramFixture {
    val bandExternalRotationKey = "landmine_anti_rotation"
    ...
    private val pairs = listOf(
        candidateRow(1, "Squat anchor", "BACK_SQUAT", "SQUAT_VARIANTS", "MAIN_LOWER_STRENGTH", "SQUAT_HEAVY_AXIAL", "ESTIMATED_1RM", "SQUAT_HEAVY_AXIAL", "HEAVY_COMPOUND_STRESS", "BARBELL", "VERY_HIGH", stableKey = "barbell_back_squat"),
        candidateRow(2, "Hinge anchor", "BARBELL_DEADLIFT", "DEADLIFT_HINGE_VARIANTS", "MAIN_HINGE_STRENGTH", "HEAVY_HINGE", "ESTIMATED_1RM", "HEAVY_HINGE", "HEAVY_COMPOUND_STRESS", "BARBELL", "VERY_HIGH", stableKey = "barbell_deadlift"),
        candidateRow(3, "Loaded row", "CHEST_SUPPORTED_ROW", "ROW_VARIANTS", "UPPER_PULL_STRENGTH", "HORIZONTAL_PULL_COMPOUND", "LOAD_REPS", "HORIZONTAL_PULL_COMPOUND", "UPPER_PULL_STRESS", "MACHINE", "MODERATE", stableKey = "ex_fa31f7a6"),
        candidateRow(4, "Vertical pull", "PULL_UP", "PULL_UP_CHIN_UP_LAT_PULLDOWN_VARIANTS", "UPPER_PULL_STRENGTH", "VERTICAL_PULL_COMPOUND", "LOAD_REPS", "VERTICAL_PULL_COMPOUND", "VERTICAL_PULL_STRESS", "BODYWEIGHT", "MODERATE", stableKey = "pull_up"),
        candidateRow(5, "Face pull", "FACE_PULL", "SCAPULAR_RETRACTION_EXTERNAL_ROTATION_CONTROL_VARIANTS", "SCAPULAR_CONTROL_ACCESSORY", "SCAPULAR_RETRACTION_EXTERNAL_ROTATION", "QUALITY_BASED", "NOT_APPLICABLE", "LOW_LOAD_PREHAB_CONTROL_STRESS", "CABLE", "LOW", rest = 60, stableKey = "face_pull"),
        candidateRow(6, "Rear delt raise", "REAR_DELT_FLY", "REAR_DELT_FLY_HORIZONTAL_ABDUCTION_VARIANTS", "REAR_DELT_SCAPULAR_ACCESSORY", "POSTERIOR_DELTOID_HORIZONTAL_ABDUCTION", "LOAD_REPS", "REAR_DELT_SCAPULAR_ACCESSORY", "ISOLATION_ACCESSORY_STRESS", "DUMBBELL", "LOW", stableKey = "ex_93538692"),
        candidateRow(7, "Pallof press", "PALLOF_PRESS", "ANTI_ROTATION_ANTI_EXTENSION_CORE_VARIANTS", "CORE_STABILITY", "TRUNK_ANTI_MOVEMENT", "QUALITY_BASED", "TRUNK_ANTI_MOVEMENT", "ISOMETRIC_CORE_BRACING_STRESS", "CABLE", "LOW", stableKey = "cable_pallof_press"),
        candidateRow(8, "Dead bug", "DEAD_BUG", "ANTI_ROTATION_ANTI_EXTENSION_CORE", "CORE_STABILITY_ACCESSORY", "CORE_BRACING_CONTROL", "TIME_OR_REPS", "CORE_BRACING_CONTROL", "ISOMETRIC_CORE_BRACING_STRESS", "BODYWEIGHT", "LOW", stableKey = "ex_d5bdffe1"),
        candidateRow(9, "Single-leg strength", "DUMBBELL_SPLIT_SQUAT", "LUNGE_SPLIT_SQUAT_VARIANTS", "UNILATERAL_LOWER_ACCESSORY", "LUNGE_UNILATERAL_LOWER", "LOAD_REPS", "LUNGE_UNILATERAL_LOWER", "UNILATERAL_LOWER_STRESS", "DUMBBELL", "MODERATE", stableKey = "ex_f2a79d37"),
        candidateRow(10, "Court footwork", "RANDOM_BEEP_FOOTWORK", "FOOTWORK_SPLIT_STEP_REACTION_DRILL_VARIANTS", "BADMINTON_FOOTWORK", "BADMINTON_COURT_FOOTWORK", "TIME_OR_REPS", "NOT_APPLICABLE", "COURT_FOOTWORK_STRESS", "BODYWEIGHT", "MODERATE", transfer = "DIRECT", stableKey = "ex_c5f4c242"),
        candidateRow(11, "Calf strength", "STANDING_CALF_RAISE", "CALF_RAISE_ANKLE_STIFFNESS_VARIANTS", "CALF_ACCESSORY", "CALF_RAISE_ANKLE_STIFFNESS", "LOAD_REPS", "CALF_RAISE_ANKLE_STIFFNESS", "LOCAL_MUSCLE_STRESS", "MACHINE", "LOW", stableKey = "standing_calf_raise_machine"),
        candidateRow(12, "Activation A", "WALL_SLIDE", "SCAPULAR_CONTROL_RECOVERY_PREHAB_VARIANTS", "RECOVERY_PREHAB_SCAPULAR_CONTROL", "SCAPULAR_UPWARD_ROTATION_CONTROL", "QUALITY_BASED", "NOT_APPLICABLE", "LOW_LOAD_PREHAB_CONTROL_STRESS", "WALL", "LOW", stableKey = "kettlebell_halo"),
        candidateRow(13, "Activation B", "SCAPULAR_PUSH_UP", "SERRATUS_SCAPULAR_PROTRACTION_CONTROL_VARIANTS", "RECOVERY_PREHAB_SCAPULAR_CONTROL", "SCAPULAR_PROTRACTION_CONTROL", "QUALITY_BASED", "NOT_APPLICABLE", "LOW_LOAD_PREHAB_CONTROL_STRESS", "BODYWEIGHT", "LOW", stableKey = "band_pallof_press"),
        ...
        candidateRow(15, "Activation D", "BIRD_DOG", "ANTI_ROTATION_ANTI_EXTENSION_CORE", "CORE_STABILITY_ACCESSORY", "CORE_BRACING_CONTROL", "TIME_OR_REPS", "CORE_BRACING_CONTROL", "ISOMETRIC_CORE_BRACING_STRESS", "BODYWEIGHT", "LOW", stableKey = "vipr_rotational_lift"),
        candidateRow(16, "Triceps accessory", "TRICEPS_PUSHDOWN", "ELBOW_EXTENSION_TRICEPS_ISOLATION_VARIANTS", "TRICEPS_ACCESSORY", "ELBOW_EXTENSION_TRICEPS", "LOAD_REPS", "ELBOW_EXTENSION_TRICEPS", "ISOLATION_ACCESSORY_STRESS", "CABLE", "LOW", stableKey = "cable_overhead_triceps_extension")
    )
    ...
    fun redFatigue(): DailyFatigueState = DailyFatigueState(
        ...
        highForceNeuralFatigue = 90.0,
        systemicMuscularFatigue = 90.0,
        localMuscularFatigue = 90.0,
        highSpeedFatigue = 90.0,
        reactiveFatigue = 90.0,
        recoveryPressure = 90.0,
        highForceNeuralScore = 90,
