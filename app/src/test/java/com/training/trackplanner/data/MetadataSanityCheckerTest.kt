...
class MetadataSanityCheckerTest {
    ...
    fun readinessReporterMarksSeedCatalogReady() {
        ...
        assertEquals(214, report.summary.totalExerciseCount)
        assertEquals(214, report.summary.fatigueReadyCounts[ReadinessStatus.YES])
        assertEquals(214, report.summary.progressReadyCounts[ReadinessStatus.YES])
        assertEquals(214, report.summary.badmintonReadyCounts[ReadinessStatus.YES])
        assertEquals(214, report.summary.balanceReadyCounts[ReadinessStatus.YES])
