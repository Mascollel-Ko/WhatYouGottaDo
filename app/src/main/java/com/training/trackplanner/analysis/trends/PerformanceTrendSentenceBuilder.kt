...
internal fun TrendMetricId.label(): String =
    when (this) {
        ...
        TrendMetricId.SQUAT_E1RM -> "스쿼트 e1RM"
        TrendMetricId.DEADLIFT_E1RM -> "데드리프트 e1RM"
        TrendMetricId.MUSCLE_QUADS_LOAD_DAILY -> "대퇴사두 운동량"
        TrendMetricId.MUSCLE_QUADS_LOAD_3D -> "대퇴사두 최근 3일 운동량"
        TrendMetricId.MUSCLE_QUADS_LOAD_7D -> "대퇴사두 최근 7일 운동량"
        TrendMetricId.MUSCLE_HAMSTRINGS_LOAD_DAILY -> "햄스트링 운동량"
        TrendMetricId.MUSCLE_HAMSTRINGS_LOAD_3D -> "햄스트링 최근 3일 운동량"
        TrendMetricId.MUSCLE_HAMSTRINGS_LOAD_7D -> "햄스트링 최근 7일 운동량"
        TrendMetricId.MUSCLE_GLUTES_LOAD_DAILY -> "둔근 운동량"
        TrendMetricId.MUSCLE_GLUTES_LOAD_3D -> "둔근 최근 3일 운동량"
        TrendMetricId.MUSCLE_GLUTES_LOAD_7D -> "둔근 최근 7일 운동량"
        TrendMetricId.MUSCLE_CALVES_LOAD_DAILY -> "종아리 운동량"
        TrendMetricId.MUSCLE_CALVES_LOAD_3D -> "종아리 최근 3일 운동량"
        TrendMetricId.MUSCLE_CALVES_LOAD_7D -> "종아리 최근 7일 운동량"
        TrendMetricId.MUSCLE_ADDUCTOR_ABDUCTOR_LOAD_DAILY -> "내전근/외전근 운동량"
        TrendMetricId.MUSCLE_ADDUCTOR_ABDUCTOR_LOAD_3D -> "내전근/외전근 최근 3일 운동량"
        TrendMetricId.MUSCLE_ADDUCTOR_ABDUCTOR_LOAD_7D -> "내전근/외전근 최근 7일 운동량"
        TrendMetricId.MUSCLE_POSTERIOR_CHAIN_ERECTORS_LOAD_DAILY -> "후면사슬/척추기립근 운동량"
        TrendMetricId.MUSCLE_POSTERIOR_CHAIN_ERECTORS_LOAD_3D -> "후면사슬/척추기립근 최근 3일 운동량"
        TrendMetricId.MUSCLE_POSTERIOR_CHAIN_ERECTORS_LOAD_7D -> "후면사슬/척추기립근 최근 7일 운동량"
        TrendMetricId.MUSCLE_CHEST_LOAD_DAILY -> "가슴 운동량"
        TrendMetricId.MUSCLE_CHEST_LOAD_3D -> "가슴 최근 3일 운동량"
        TrendMetricId.MUSCLE_CHEST_LOAD_7D -> "가슴 최근 7일 운동량"
        TrendMetricId.MUSCLE_BACK_LATS_LOAD_DAILY -> "등/광배 운동량"
        TrendMetricId.MUSCLE_BACK_LATS_LOAD_3D -> "등/광배 최근 3일 운동량"
        TrendMetricId.MUSCLE_BACK_LATS_LOAD_7D -> "등/광배 최근 7일 운동량"
        TrendMetricId.MUSCLE_SHOULDERS_LOAD_DAILY -> "어깨 운동량"
        TrendMetricId.MUSCLE_SHOULDERS_LOAD_3D -> "어깨 최근 3일 운동량"
        TrendMetricId.MUSCLE_SHOULDERS_LOAD_7D -> "어깨 최근 7일 운동량"
        TrendMetricId.MUSCLE_BICEPS_LOAD_DAILY -> "이두 운동량"
        TrendMetricId.MUSCLE_BICEPS_LOAD_3D -> "이두 최근 3일 운동량"
        TrendMetricId.MUSCLE_BICEPS_LOAD_7D -> "이두 최근 7일 운동량"
        TrendMetricId.MUSCLE_TRICEPS_LOAD_DAILY -> "삼두 운동량"
        TrendMetricId.MUSCLE_TRICEPS_LOAD_3D -> "삼두 최근 3일 운동량"
        TrendMetricId.MUSCLE_TRICEPS_LOAD_7D -> "삼두 최근 7일 운동량"
        TrendMetricId.MUSCLE_FOREARM_GRIP_LOAD_DAILY -> "전완/그립 운동량"
        TrendMetricId.MUSCLE_FOREARM_GRIP_LOAD_3D -> "전완/그립 최근 3일 운동량"
        TrendMetricId.MUSCLE_FOREARM_GRIP_LOAD_7D -> "전완/그립 최근 7일 운동량"
        TrendMetricId.MUSCLE_ANTERIOR_CORE_LOAD_DAILY -> "복근/전면코어 운동량"
        TrendMetricId.MUSCLE_ANTERIOR_CORE_LOAD_3D -> "복근/전면코어 최근 3일 운동량"
        TrendMetricId.MUSCLE_ANTERIOR_CORE_LOAD_7D -> "복근/전면코어 최근 7일 운동량"
        TrendMetricId.MUSCLE_LATERAL_CORE_LOAD_DAILY -> "측면코어 운동량"
        TrendMetricId.MUSCLE_LATERAL_CORE_LOAD_3D -> "측면코어 최근 3일 운동량"
        TrendMetricId.MUSCLE_LATERAL_CORE_LOAD_7D -> "측면코어 최근 7일 운동량"
        TrendMetricId.MUSCLE_ROTATION_CORE_LOAD_DAILY -> "항회전/회전코어 운동량"
        TrendMetricId.MUSCLE_ROTATION_CORE_LOAD_3D -> "항회전/회전코어 최근 3일 운동량"
        TrendMetricId.MUSCLE_ROTATION_CORE_LOAD_7D -> "항회전/회전코어 최근 7일 운동량"
