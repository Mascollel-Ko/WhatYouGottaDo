...
object FatigueThresholds {
    ...
    const val PRESENTATION_RESTRICTED_SCORE = 84
    const val PRESENTATION_VERY_HIGH_SCORE = 100
    const val PRESENTATION_VOLUME_YELLOW_START = 54
    const val PRESENTATION_VOLUME_ORANGE_START = 72
    const val PRESENTATION_VOLUME_RED_START = 90

    const val PRESSURE_ELEVATED_RATIO = 1.3754
    const val PRESSURE_HIGH_RATIO = 1.6146
    const val PRESSURE_VERY_HIGH_RATIO = 1.9136
    const val Z_ELEVATED = 1.196
    const val Z_HIGH = 1.794
    const val Z_VERY_HIGH = 2.392
