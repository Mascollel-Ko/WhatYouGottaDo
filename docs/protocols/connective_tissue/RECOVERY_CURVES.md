...
각 event/load unit은 protocol class와 profile에 따라 독립 회복 곡선을 사용합니다. 잔여 노출은 현재 모델 channel의 max이며 biological remodeling 자체를 뜻하지 않습니다.
...
이 문서는 `CT-RECOVERY-CURVES`가 소유한 현재 runtime 동작과 직접 연결된 source, tests, authority assets에 적용됩니다.
...
21개 curve의 114 knot를 PCHIP로 보간합니다. exact knot를 통과하고 overshoot를 만들지 않으며 출력은 0~1.25로 제한합니다. 7개 routing row가 protocol class를 curve로 연결합니다.
...
Evidence profile은 `MIXED, RESEARCH_TRANSFER, LOW_CONFIDENCE_PROXY, PRODUCT_POLICY`입니다. 이는 source와 repository 안의 supporting evidence를 구분해 기록한 것으로, implementation status나 임상 검증을 대신하지 않습니다.
...
- 일부 recovery class는 직접 조직별 human evidence가 아닌 class proxy를 사용합니다.
...
- [`app/src/main/java/com/training/trackplanner/analysis/tissue/TissuePchipInterpolator.kt`](../../../app/src/main/java/com/training/trackplanner/analysis/tissue/TissuePchipInterpolator.kt)
...
- [`app/src/main/assets/metadata/tissue_load_v1/tissue_rcv_recovery_curve_knots_v1.csv`](../../../app/src/main/assets/metadata/tissue_load_v1/tissue_rcv_recovery_curve_knots_v1.csv)
- [`app/src/main/assets/metadata/tissue_load_v1/tissue_rcv_recovery_routing_v1.csv`](../../../app/src/main/assets/metadata/tissue_load_v1/tissue_rcv_recovery_routing_v1.csv)
- [`app/src/main/assets/metadata/tissue_load_v1/tissue_rcv_recovery_evidence_v1.csv`](../../../app/src/main/assets/metadata/tissue_load_v1/tissue_rcv_recovery_evidence_v1.csv)
