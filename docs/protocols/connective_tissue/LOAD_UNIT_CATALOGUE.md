...
77개 unsided load unit을 조직 종류와 15개 joint complex에 연결합니다. 좌우를 추정해 새 identity를 만들지 않습니다.
...
load unit stable key, tissue type, joint complex, display order와 authority relationship을 asset 그대로 읽습니다. 조직 유형을 generic joint score 하나로 축소하지 않습니다.
