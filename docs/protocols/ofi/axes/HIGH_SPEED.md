...
stable protocol ID의 `HIGH_SPEED`는 현재 UI의 관절·건·충격 축을 가리킵니다. 점프, 감속, 방향전환, 달리기와 무거운 축성 부하를 모델링합니다.
...
impact/jump 1.25, direction/deceleration 1.15, sport/running/court 1.15, heavy axial 1.15, tendon tag 1.10을 적용하고 15회 이상과 RPE 9 이상에 각각 1.10을 적용합니다.

## 8. 집계 방식

확인된 set/entry의 일별 raw contribution을 합친 뒤 decay를 적용하고 개인 baseline과 비교합니다. UI 축 이름은 `관절·건·충격`입니다.
