...
현재 공개 builder는 rule table candidate, slot cap, main-area 중복과 selected-main 관련 좁은 중복 방지로 대체 후보를 선택합니다.
...
이 문서는 `PROGRAM-BUILDER-CONSTRAINTS`가 소유한 현재 runtime 동작과 직접 연결된 source, tests, authority assets에 적용됩니다.
...
현재 slot, main area, selected-main stable key/family, 이미 배치한 운동과 deterministic rule-table 후보를 사용합니다.
...
- [`docs/v0.4.1.10.9_program_builder_selected_main_slot_repair_worklog.md`](../../v0.4.1.10.9_program_builder_selected_main_slot_repair_worklog.md)
