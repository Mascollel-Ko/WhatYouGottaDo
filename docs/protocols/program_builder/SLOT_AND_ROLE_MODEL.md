...
현재 공개 builder는 MAIN, STRENGTH_ACCESSORY, BADMINTON_ACCESSORY role과 main/paired/small 배치 순서를 사용합니다.
...
이 문서는 `PROGRAM-BUILDER-SLOTS`가 소유한 현재 runtime 동작과 직접 연결된 source, tests, authority assets에 적용됩니다.
...
30/45/60분 session cap은 각각 3/4/5 slot이며 main cap은 2입니다. main area는 lower anterior, lower posterior, chest, shoulder, back입니다. 배치는 main, secondary main, badminton accessory, paired, small 순서입니다.
