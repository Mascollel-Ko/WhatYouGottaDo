...
이 문서는 `PROGRAM-BUILDER-EVALUATION`가 소유한 현재 runtime 동작과 직접 연결된 source, tests, authority assets에 적용됩니다.
...
- [`docs/v0.4.1.10.4_program_builder_quality_worklog.md`](../../v0.4.1.10.4_program_builder_quality_worklog.md)
