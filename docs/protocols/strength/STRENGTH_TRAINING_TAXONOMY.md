...
근력 운동을 movement pattern, body region, role, slot, progression group, muscle, equipment와 analysis eligibility로 분류합니다.
...
이 문서는 `STRENGTH-TAXONOMY`가 소유한 현재 runtime 동작과 직접 연결된 source, tests, authority assets에 적용됩니다.
...
effective runtime metadata의 stable key와 명시 token을 우선합니다. 좁은 exercise-specific 계산 예외를 전체 movement family로 일반화하지 않습니다.
...
- legacy family/name compatibility 입력이 남아 있지만 stable-key metadata가 우선입니다.
...
- [`app/src/main/java/com/training/trackplanner/data/ExerciseTaxonomy.kt`](../../../app/src/main/java/com/training/trackplanner/data/ExerciseTaxonomy.kt)
- [`app/src/main/java/com/training/trackplanner/data/ExerciseMetadataTaxonomy.kt`](../../../app/src/main/java/com/training/trackplanner/data/ExerciseMetadataTaxonomy.kt)
- [`app/src/main/java/com/training/trackplanner/analysis/features/ExerciseAnalysisMapper.kt`](../../../app/src/main/java/com/training/trackplanner/analysis/features/ExerciseAnalysisMapper.kt)

## 17. 검증 테스트

- [`app/src/test/java/com/training/trackplanner/data/ExerciseSeedMetadataPolicyTest.kt`](../../../app/src/test/java/com/training/trackplanner/data/ExerciseSeedMetadataPolicyTest.kt)
