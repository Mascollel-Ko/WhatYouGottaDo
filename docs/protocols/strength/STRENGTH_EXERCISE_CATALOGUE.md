...
이 문서는 `STRENGTH-CATALOGUE`가 소유한 현재 runtime 동작과 직접 연결된 source, tests, authority assets에 적용됩니다.
...
- row와 custom override별 evidence/source confidence가 다릅니다.
...
- [`docs/runtime_metadata_user_exercises_v0.3.5.1.md`](../../runtime_metadata_user_exercises_v0.3.5.1.md)
