...
| `BADMINTON` | `BADMINTON-VOLUME` | 배드민턴 훈련량 계산 | `1.2.0` | `ACTIVE` | `IMPLEMENTED` | MIXED, PRODUCT_POLICY, ENGINEERING_HEURISTIC | `UNKNOWN_PENDING_AUDIT`; practice/objective boundary `v0.5.0.33`; legacy seven-axis retired `v0.5.0.35` | `e2fb51f` | [문서](badminton/BADMINTON_VOLUME_CALCULATION.md) |
