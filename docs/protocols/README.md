...
| `DATA_PORTABILITY` | `DATA-CLOUD-BACKUP` | 클라우드 백업 | `1.1.0` | `DRAFT` | `PARTIALLY_IMPLEMENTED` | PRODUCT_POLICY, ENGINEERING_HEURISTIC | `UNRELEASED_PHASE_2_SUPABASE_TRANSPORT` | `71e4dbd171ea395b9979988a185cc34654537281` | [문서](data_portability/CLOUD_BACKUP.md) |
