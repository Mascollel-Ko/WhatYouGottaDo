...
| `STRENGTH` | `STRENGTH-PROXY-PERFORMANCE` | 지속형 근력 수행능력 사후분포 | `3.0.1` | `EXPERIMENTAL` | `IMPLEMENTED` | DIRECT_RESEARCH_SUPPORT, PRODUCT_POLICY, ENGINEERING_HEURISTIC, LOW_CONFIDENCE_PROXY | `v0.5.0.3`; canonical identity rebuild `v0.5.0.6` | `401ece4ca451b5303b3607bf8b3462b95f25a581` | [문서](strength/PROXY_PERFORMANCE_ESTIMATION.md) |
...
| `DATA_PORTABILITY` | `DATA-EXERCISE-IDENTITY` | 운동 identity와 정본화 | `1.0.0` | `ACTIVE` | `IMPLEMENTED` | PRODUCT_POLICY, ENGINEERING_HEURISTIC | `v0.5.0.6` | `401ece4ca451b5303b3607bf8b3462b95f25a581` | [문서](data_portability/EXERCISE_IDENTITY_AND_CANONICALIZATION.md) |
