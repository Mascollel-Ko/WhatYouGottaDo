...
| `DATA_PORTABILITY` | `DATA-CLOUD-BACKUP` | 클라우드 백업 | `1.1.0` | `DRAFT` | `PARTIALLY_IMPLEMENTED` | PRODUCT_POLICY, ENGINEERING_HEURISTIC | `UNRELEASED_PHASE_1_B2` | `f8e47838df238c54df62412fcce6ecc902418143` | [문서](data_portability/CLOUD_BACKUP.md) |
