...
| `STRENGTH` | `STRENGTH-VOLUME` | 근력훈련 volume 계산 | `1.3.0` | `ACTIVE` | `IMPLEMENTED` | MIXED, PRODUCT_POLICY, ENGINEERING_HEURISTIC | `UNKNOWN_PENDING_AUDIT`; CoreStimulus V1 `v0.5.0.33`; Lab unification `v0.5.0.35` | `56df5ea` | [문서](strength/STRENGTH_VOLUME_CALCULATION.md) |
...
| `DATA_PORTABILITY` | `DATA-EXERCISE-IDENTITY` | 운동 identity와 정본화 | `1.4.0` | `ACTIVE` | `IMPLEMENTED` | PRODUCT_POLICY, ENGINEERING_HEURISTIC | `v0.5.0.6`; workbook authority `v0.5.0.22`; self-contained restore `v0.5.0.24`; explicit ownership `v0.5.0.25`; relation normalization `v0.5.0.32` | `b44088c2a32d7222d97e5a213a2efea02d250f10` | [문서](data_portability/EXERCISE_IDENTITY_AND_CANONICALIZATION.md) |
