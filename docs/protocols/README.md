...
| `STRENGTH` | `STRENGTH-VOLUME` | 근력훈련 volume 계산 | `1.0.1` | `ACTIVE` | `IMPLEMENTED` | MIXED, PRODUCT_POLICY, ENGINEERING_HEURISTIC | `UNKNOWN_PENDING_AUDIT`; chart dates/e1RM domain `v0.4.2.16` | `60e21c6b847f1dc2910ddbdc5ee2d4690631cb9e` | [문서](strength/STRENGTH_VOLUME_CALCULATION.md) |
