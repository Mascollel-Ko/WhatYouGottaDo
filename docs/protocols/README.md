...
| `DATA_PORTABILITY` | `DATA-CLOUD-BACKUP` | 클라우드 백업 | `1.0.1` | `DRAFT` | `PARTIALLY_IMPLEMENTED` | PRODUCT_POLICY, ENGINEERING_HEURISTIC | `UNRELEASED_PHASE_1_B1` | `890d08c89bd71c9ffc0db7a9e8c19c7b820d62ce` | [문서](data_portability/CLOUD_BACKUP.md) |
