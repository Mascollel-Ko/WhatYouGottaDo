...
| `CONNECTIVE_TISSUE` | `CT-PERSONAL-CALIBRATION` | 연결조직 개인 보정 | `1.1.0` | `ACTIVE` | `IMPLEMENTED` | PRODUCT_POLICY, ENGINEERING_HEURISTIC | `v0.4.2.7` | `22e51779bbd173e554c3ba1dbeec0fcf13a6ba20` | [문서](connective_tissue/PERSONAL_CALIBRATION.md) |
...
- `CT-PERSONAL-CALIBRATION`의 기존 personal-history percentile은 runtime `IMPLEMENTED`입니다. 새 BasePrior artifacts와 pure adjustment evaluator는 `DESIGNED / GENERATED / VALIDATED / NOT_YET_RUNTIME_ACTIVE`이며 현재 UI/classifier가 소비하지 않습니다.
