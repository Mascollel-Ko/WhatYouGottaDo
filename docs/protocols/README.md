...
| `DATA_PORTABILITY` | `DATA-METADATA-ANALYSIS-CONTRACT` | 메타데이터 분석 계약 | `1.2.0` | `ACTIVE` | `PARTIALLY_IMPLEMENTED` | PRODUCT_POLICY, ENGINEERING_HEURISTIC | `v0.5.0.16` shadow baseline; v2.2 Phase 2A audit `v0.5.0.18` | `888850e` | [문서](data_portability/METADATA_ANALYSIS_CONTRACT_PHASE_0_1.md) |
