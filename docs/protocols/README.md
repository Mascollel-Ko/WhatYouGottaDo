...
| `OFI` | `OFI-CLASSIFICATION` | OFI 분류와 표시 | `1.1.1` | `ACTIVE` | `IMPLEMENTED` | USER_APPROVED_POLICY, PRODUCT_POLICY | `v0.4.2.15`; chart dates `v0.4.2.16` | `60e21c6b847f1dc2910ddbdc5ee2d4690631cb9e` | [문서](ofi/OFI_CLASSIFICATION_AND_PRESENTATION.md) |
