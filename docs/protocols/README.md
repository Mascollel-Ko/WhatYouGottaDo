...
| `CONNECTIVE_TISSUE` | `CT-RANKING-PRESENTATION` | 연결조직 순위와 표시 | `2.1.0` | `ACTIVE` | `IMPLEMENTED` | PRODUCT_POLICY, USER_APPROVED_POLICY | `v0.4.2.8`; EDU-2 `v0.4.2.13` | `f2479c8cbf89649469495966d3e8cc09ff49ad8d` | [문서](connective_tissue/RANKING_AND_PRESENTATION.md) |
