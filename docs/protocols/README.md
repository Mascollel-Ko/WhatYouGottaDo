...
| `DATA_PORTABILITY` | `DATA-CLOUD-BACKUP` | 클라우드 백업 | `1.0.1` | `DRAFT` | `SPECIFICATION_ONLY` | PRODUCT_POLICY, ENGINEERING_HEURISTIC | `NOT_IMPLEMENTED` | `b742693b8e4dc0ea2207b0913e26f27f0db56d2e` | [문서](data_portability/CLOUD_BACKUP.md) |
