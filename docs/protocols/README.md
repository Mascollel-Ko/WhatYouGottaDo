...
| `PROGRAM_BUILDER` | `PROGRAM-BUILDER-OVERVIEW` | 자동 프로그램 생성 개요 | `1.5.0` | `ACTIVE` | `IMPLEMENTED` | PRODUCT_POLICY, ENGINEERING_HEURISTIC | `v0.4.2.0`; exact stableKey candidate authority `v0.5.0.35`; dead advanced path removed `v0.5.0.37` | `ce93b32` | [문서](program_builder/PROGRAM_BUILDER_OVERVIEW.md) |
