...
| `STRENGTH` | `STRENGTH-PROXY-PERFORMANCE` | 지속형 근력 수행능력 사후분포 | `2.1.0` | `EXPERIMENTAL` | `IMPLEMENTED` | DIRECT_RESEARCH_SUPPORT, PRODUCT_POLICY, ENGINEERING_HEURISTIC, LOW_CONFIDENCE_PROXY | `v0.5.0.2` | `0a949d7` | [문서](strength/PROXY_PERFORMANCE_ESTIMATION.md) |
