...
| `DATA_PORTABILITY` | `DATA-CLOUD-BACKUP` | 클라우드 백업 | `1.0.0` | `DRAFT` | `SPECIFICATION_ONLY` | PRODUCT_POLICY, ENGINEERING_HEURISTIC | `NOT_IMPLEMENTED` | `a56eaad3ad9a1a7afc33cb3cbfff9f963202c6bc` | [문서](data_portability/CLOUD_BACKUP.md) |
