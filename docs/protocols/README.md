...
| `CONNECTIVE_TISSUE` | `CT-OVERVIEW` | 연결조직 부하·회복 개요 | `2.0.0` | `ACTIVE` | `IMPLEMENTED` | MIXED, RESEARCH_TRANSFER, PRODUCT_POLICY, LOW_CONFIDENCE_PROXY | `v0.4.2.7` | `b95a1684ad8bc0ba82cd5eae52ccb3147eae4d61` | [문서](connective_tissue/CONNECTIVE_TISSUE_OVERVIEW.md) |
...
| `CONNECTIVE_TISSUE` | `CT-RANKING-PRESENTATION` | 연결조직 순위와 표시 | `2.0.0` | `ACTIVE` | `IMPLEMENTED` | PRODUCT_POLICY, USER_APPROVED_POLICY | `v0.4.2.8` | `0974433ef5e21f4a5f2dee8a3bbe72418d9c3f9f` | [문서](connective_tissue/RANKING_AND_PRESENTATION.md) |
