...
| `BADMINTON` | `BADMINTON-TAXONOMY` | 배드민턴 훈련 taxonomy | `1.2.0` | `ACTIVE` | `IMPLEMENTED`; identity closeout `ARTIFACT_ONLY` | MIXED, PRODUCT_POLICY, RESEARCH_TRANSFER | `UNKNOWN_PENDING_AUDIT`; stableKey/taxonomy closeout `2026-08-04`; explicit canonical transfer authority `v0.5.0.32` | `86c56ca4f74c02f4d1da48b4dd985106642ae42b` | [문서](badminton/BADMINTON_TRAINING_TAXONOMY.md) |
...
| `BADMINTON` | `BADMINTON-TRANSFER` | 배드민턴 전이 분류 | `1.2.0` | `ACTIVE` | `IMPLEMENTED`; relation closeout `ARTIFACT_ONLY` | MIXED, RESEARCH_TRANSFER, PRODUCT_POLICY | `UNKNOWN_PENDING_AUDIT`; chart dates `v0.4.2.16`; relation closeout `2026-08-04`; explicit canonical transfer authority `v0.5.0.32` | `86c56ca4f74c02f4d1da48b4dd985106642ae42b` | [문서](badminton/BADMINTON_TRANSFER_CATEGORIES.md) |
...
| `STRENGTH` | `STRENGTH-TAXONOMY` | 근력훈련 taxonomy | `1.1.0` | `ACTIVE` | `IMPLEMENTED` | MIXED, PRODUCT_POLICY, RESEARCH_TRANSFER | `v0.3.5.0`; canonical trunk-control normalization `v0.5.0.32` | `06b65f6cdb243780e97a7464f659219b50010c7c` | [문서](strength/STRENGTH_TRAINING_TAXONOMY.md) |
...
| `DATA_PORTABILITY` | `DATA-METADATA-ANALYSIS-CONTRACT` | 메타데이터 분석 계약 | `1.9.0` | `ACTIVE` | `PARTIALLY_IMPLEMENTED` | PRODUCT_POLICY, ENGINEERING_HEURISTIC | `v0.5.0.16` shadow baseline; bundled authority `v0.5.0.22`; explicit ownership `v0.5.0.25`; fieldKey routing `v0.5.0.26`; canonical normalization `v0.5.0.32` | `28f40346492d1f7df9e593214a3b806295f27222` | [문서](data_portability/METADATA_ANALYSIS_CONTRACT_PHASE_0_1.md) |
