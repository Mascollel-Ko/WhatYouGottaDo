...
| `STRENGTH` | `STRENGTH-PROXY-PERFORMANCE` | 지속형 근력 수행능력 사후분포 | `3.0.2` | `EXPERIMENTAL` | `IMPLEMENTED` | DIRECT_RESEARCH_SUPPORT, PRODUCT_POLICY, ENGINEERING_HEURISTIC, LOW_CONFIDENCE_PROXY | `v0.5.0.3`; isolated five-target prior preflight `v0.5.0.19` | `40615fab9c7ff892b0e48dd5a244eeb77e7cf2ee` | [문서](strength/PROXY_PERFORMANCE_ESTIMATION.md) |
