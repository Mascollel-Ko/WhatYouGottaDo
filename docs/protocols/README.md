...
| `BADMINTON` | `BADMINTON-TRANSFER` | 배드민턴 전이 분류 | `2.2.0` | `ACTIVE` | `IMPLEMENTED`; relation closeout `ARTIFACT_ONLY` | MIXED, RESEARCH_TRANSFER, PRODUCT_POLICY | `UNKNOWN_PENDING_AUDIT`; objective stimulus `v0.5.0.33`; legacy seven-axis retired `v0.5.0.35` | `e2fb51f` | [문서](badminton/BADMINTON_TRANSFER_CATEGORIES.md) |
...
| `STRENGTH` | `STRENGTH-VOLUME` | 근력훈련 volume 계산 | `1.4.0` | `ACTIVE` | `IMPLEMENTED` | MIXED, PRODUCT_POLICY, ENGINEERING_HEURISTIC | `UNKNOWN_PENDING_AUDIT`; CoreStimulus V1 `v0.5.0.33`; Lab unification `v0.5.0.35`; exact load/muscle authority `v0.5.0.36` | `79998bf` | [문서](strength/STRENGTH_VOLUME_CALCULATION.md) |
| `STRENGTH` | `STRENGTH-PROXY-PERFORMANCE` | 지속형 근력 수행능력 사후분포 | `3.1.1` | `EXPERIMENTAL` | `IMPLEMENTED`; relation closeout `ARTIFACT_ONLY` | DIRECT_RESEARCH_SUPPORT, PRODUCT_POLICY, ENGINEERING_HEURISTIC, LOW_CONFIDENCE_PROXY | `v0.5.0.3`; isolated five-target prior preflight `v0.5.0.19`; 17-relation closeout `2026-08-04`; disconnected experiment retired `v0.5.0.36` | `79998bf` | [문서](strength/PROXY_PERFORMANCE_ESTIMATION.md) |
| `STRENGTH` | `STRENGTH-BODYWEIGHT-LOAD` | 체중 운동 유효 부하 | `1.1.0` | `ACTIVE` | `IMPLEMENTED` | PRODUCT_POLICY, ENGINEERING_HEURISTIC | `UNKNOWN_PENDING_AUDIT`; weighted pull-up posterior boundary `v0.5.0.2`; exact stableKey profiles `v0.5.0.36` | `bb045da` | [문서](strength/BODYWEIGHT_EFFECTIVE_LOAD.md) |
...
| `PROGRAM_BUILDER` | `PROGRAM-BUILDER-OVERVIEW` | 자동 프로그램 생성 개요 | `1.4.0` | `ACTIVE` | `IMPLEMENTED` | PRODUCT_POLICY, ENGINEERING_HEURISTIC | `v0.4.2.0`; exact stableKey candidate authority `v0.5.0.35` | `ce93b32` | [문서](program_builder/PROGRAM_BUILDER_OVERVIEW.md) |
...
| `PROGRAM_BUILDER` | `PROGRAM-BUILDER-SCORING` | 운동 선택과 우선순위 | `1.1.0` | `ACTIVE` | `PARTIALLY_IMPLEMENTED` | PRODUCT_POLICY, ENGINEERING_HEURISTIC | `v0.4.2.0`; exact stableKey candidate authority `v0.5.0.35` | `ce93b32` | [문서](program_builder/EXERCISE_SELECTION_AND_SCORING.md) |
...
| `DATA_PORTABILITY` | `DATA-EXERCISE-IDENTITY` | 운동 identity와 정본화 | `1.5.0` | `ACTIVE` | `IMPLEMENTED` | PRODUCT_POLICY, ENGINEERING_HEURISTIC | `v0.5.0.6`; workbook authority `v0.5.0.22`; self-contained restore `v0.5.0.24`; explicit ownership `v0.5.0.25`; relation normalization `v0.5.0.32`; analysis name boundary `v0.5.0.36` | `acf1d3f` | [문서](data_portability/EXERCISE_IDENTITY_AND_CANONICALIZATION.md) |
...
| `DATA_PORTABILITY` | `DATA-METADATA-ANALYSIS-CONTRACT` | 메타데이터 분석 계약 | `2.0.0` | `ACTIVE` | `PARTIALLY_IMPLEMENTED` | PRODUCT_POLICY, ENGINEERING_HEURISTIC | `v0.5.0.16` shadow baseline; canonical core/objective cutover `v0.5.0.33` | `532d2343cafd9e54924dc52350c6e108893b4b07` | [문서](data_portability/METADATA_ANALYSIS_CONTRACT_PHASE_0_1.md) |
