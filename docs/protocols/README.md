...
| `PROGRAM_BUILDER` | `PROGRAM-BUILDER-OVERVIEW` | 자동·기록 기반 프로그램 생성 개요 | `3.3.0` | `ACTIVE` | `IMPLEMENTED` | PRODUCT_POLICY, ENGINEERING_HEURISTIC | `v0.4.2.0`; independent record-based builder `v0.5.1.4`; v0.13 training state `2026-09-05` | [canonical audit](program_builder/PROGRAM_BUILDER_OVERVIEW.md) | [문서](program_builder/PROGRAM_BUILDER_OVERVIEW.md) |
