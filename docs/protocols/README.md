...
| `PROGRAM_BUILDER` | `PROGRAM-BUILDER-OVERVIEW` | 자동·기록 기반 프로그램 생성 개요 | `3.1.0` | `ACTIVE` | `IMPLEMENTED` | PRODUCT_POLICY, ENGINEERING_HEURISTIC | `v0.4.2.0`; independent record-based builder `v0.5.1.4`; v0.11 representation planner `2026-09-04` | `8ceefa3dc42cc1683c2b0e88c9aee1efe46ba606` | [문서](program_builder/PROGRAM_BUILDER_OVERVIEW.md) |
