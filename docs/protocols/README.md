...
| `PROGRAM_BUILDER` | `PROGRAM-BUILDER-OVERVIEW` | 자동·기록 기반 프로그램 생성 개요 | `3.1.1` | `ACTIVE` | `IMPLEMENTED` | PRODUCT_POLICY, ENGINEERING_HEURISTIC | `v0.4.2.0`; independent record-based builder `v0.5.1.4`; v0.11.1 correctness patch `2026-09-04` | `14f11d124a7f7e8f7ed64de47b1ea081c4ba7e3c` | [문서](program_builder/PROGRAM_BUILDER_OVERVIEW.md) |
