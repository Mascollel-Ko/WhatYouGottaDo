...
| `OFI` | `OFI-CLASSIFICATION` | OFI 분류와 표시 | `1.2.0` | `ACTIVE` | `IMPLEMENTED` | USER_APPROVED_POLICY, PRODUCT_POLICY | `v0.4.2.15`; chart dates `v0.4.2.16`; quiet summary `v0.5.0.0` | `7c29fa80b31fad642273e0a3ec5924109dafac21` | [문서](ofi/OFI_CLASSIFICATION_AND_PRESENTATION.md) |
...
| `CONNECTIVE_TISSUE` | `CT-LOAD-UNIT-CATALOGUE` | 연결조직 load unit catalogue | `1.1.0` | `ACTIVE` | `IMPLEMENTED` | MIXED, PRODUCT_POLICY, RESEARCH_TRANSFER | `v0.4.2.7`; EDU-2 `v0.4.2.13` | `f2479c8cbf89649469495966d3e8cc09ff49ad8d` | [문서](connective_tissue/LOAD_UNIT_CATALOGUE.md) |
...
| `BADMINTON` | `BADMINTON-TRANSFER` | 배드민턴 전이 분류 | `1.0.1` | `ACTIVE` | `IMPLEMENTED` | MIXED, RESEARCH_TRANSFER, PRODUCT_POLICY | `UNKNOWN_PENDING_AUDIT`; chart dates `v0.4.2.16` | `60e21c6b847f1dc2910ddbdc5ee2d4690631cb9e` | [문서](badminton/BADMINTON_TRANSFER_CATEGORIES.md) |
...
| `STRENGTH` | `STRENGTH-VOLUME` | 근력훈련 volume 계산 | `1.0.2` | `ACTIVE` | `IMPLEMENTED` | MIXED, PRODUCT_POLICY, ENGINEERING_HEURISTIC | `UNKNOWN_PENDING_AUDIT`; chart dates/e1RM domain `v0.4.2.16`; proxy boundary `v0.5.0.1` | `afcf891556b9178ca4e4453031b7184cca0d17af` | [문서](strength/STRENGTH_VOLUME_CALCULATION.md) |
| `STRENGTH` | `STRENGTH-PROXY-PERFORMANCE` | 주요 리프트 프록시 수행 추정 | `1.0.0` | `EXPERIMENTAL` | `IMPLEMENTED` | MIXED, PRODUCT_POLICY, ENGINEERING_HEURISTIC, LOW_CONFIDENCE_PROXY | `v0.5.0.1` | `afcf891556b9178ca4e4453031b7184cca0d17af` | [문서](strength/PROXY_PERFORMANCE_ESTIMATION.md) |
