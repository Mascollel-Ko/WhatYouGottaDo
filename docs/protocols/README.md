...
| `OFI` | `OFI-CLASSIFICATION` | OFI 분류와 표시 | `1.1.0` | `ACTIVE` | `IMPLEMENTED` | USER_APPROVED_POLICY, PRODUCT_POLICY | `v0.4.2.15` | `aa08b49ff183c60c45c9e8bf95a9542df1b592ce` | [문서](ofi/OFI_CLASSIFICATION_AND_PRESENTATION.md) |
