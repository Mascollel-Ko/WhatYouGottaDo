...
- Production remains one CONTROL plus one EXPERIMENTAL build with a third-build count of zero; progress/fingerprint routing is unchanged and the B9.2 boundary remains intact. A final push-triggered docs/HEAD CI record will be appended after the documentation commit is validated.
