...
- Starting verified `main` was `f499dc86d0db74b5c6606cf13dd82622ad7377f7` (protocol `3.45.2`). Implementation and focused-test commit is `d0a429f2`; the protocol registry and overview intentionally record that implementation/test SHA as `lastAuditedCommit`.
