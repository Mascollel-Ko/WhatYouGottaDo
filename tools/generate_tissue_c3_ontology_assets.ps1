...
$measurements = @(
    ...
    Row ([ordered]@{ measurementMetric='MODELED_TENDON_STRESS'; measurementFamily='INTERNAL_TENDON_STRESS'; metricOrigin=$sourceObserved; compatibleMechanicalLoadModes='TENSION'; compatibleTemporalMetrics='PEAK|ECCENTRIC_PHASE_PEAK'; requiredModelAssumptions='Cross-sectional area and tendon-force model assumptions required' })
    ...
    Row ([ordered]@{ measurementMetric='MODELED_TENDON_STRESS_TIME_INTEGRAL'; measurementFamily='INTERNAL_TENDON_STRESS_IMPULSE'; metricOrigin=$sourceObserved; compatibleMechanicalLoadModes='TENSION'; compatibleTemporalMetrics='IMPULSE_PER_EVENT|ECCENTRIC_PHASE_IMPULSE'; requiredModelAssumptions='Integration interval, cross-sectional area, and tendon-force model required' })
    ...
    Row ([ordered]@{ measurementMetric='MODELED_TENDON_STRESS_LOADING_RATE'; measurementFamily='INTERNAL_TENDON_STRESS_RATE'; metricOrigin=$sourceObserved; compatibleMechanicalLoadModes='TENSION'; compatibleTemporalMetrics='LOADING_RATE'; requiredModelAssumptions='Rate window, cross-sectional area, and tendon-force model required' })
    ...
    Row ([ordered]@{ measurementMetric='SOURCE_DEFINED_KINEMATIC_STABILITY_PROXY'; measurementFamily='SOURCE_DEFINED_KINEMATIC_PROXY'; metricOrigin=$sourceObserved; compatibleMechanicalLoadModes='ROTATIONAL_STRESS|INVERSION_STRESS|EVERSION_STRESS|END_RANGE_STRESS'; compatibleTemporalMetrics='PEAK'; requiredModelAssumptions='Source protocol required; no internal tissue-load interpretation without an approved mapping' })
...
$normalizations = @(
    ...
    Row ([ordered]@{ normalizationBasis='MEASURED_TENDON_STRAIN_PERCENT'; unitFamily='STRAIN'; biomechanicalMeaning='Measured tendon strain percentage'; compatibleMeasurementMetrics='MEASURED_TENDON_STRAIN' })
    Row ([ordered]@{ normalizationBasis='MEASURED_LIGAMENT_STRAIN_PERCENT'; unitFamily='STRAIN'; biomechanicalMeaning='Measured ligament strain percentage'; compatibleMeasurementMetrics='MEASURED_LIGAMENT_STRAIN' })
    ...
    Row ([ordered]@{ normalizationBasis='UNNORMALIZED_SOURCE_VALUE'; unitFamily='SOURCE_REPORTED'; biomechanicalMeaning='Source value retained without conversion'; compatibleMeasurementMetrics="$forceMetrics|MODELED_TENDON_STRESS|MEASURED_TENDON_STRAIN|MEASURED_LIGAMENT_STRAIN|EXTERNAL_JOINT_MOMENT|$impulseMetrics|MODELED_TENDON_STRESS_TIME_INTEGRAL|$rateMetrics|MODELED_TENDON_STRESS_LOADING_RATE|EVENT_COUNT|SOURCE_DEFINED_CYCLIC_EXPOSURE|SOURCE_DEFINED_KINEMATIC_STABILITY_PROXY|MEASURED_TENDON_ENERGY_STORAGE|MODELED_TENDON_ENERGY_STORAGE|GROUND_REACTION_FORCE" })
)
...
Add-Dimension 'ACH_TENSION_PEAK' 'TENDON' 'ACHILLES_TENDON' 'TENSION' 'PEAK' 'MODELED_TENDON_FORCE|MODELED_TENDON_STRESS|MEASURED_TENDON_STRAIN' "$f|MEASURED_TENDON_STRAIN_PERCENT|UNNORMALIZED_SOURCE_VALUE" 'SOURCE_OBSERVED' '' 'true' 'false' 'PEAK_TENSILE_LOAD|TENDON_STRAIN'
Add-Dimension 'ACH_TENSION_IMPULSE_EVENT' 'TENDON' 'ACHILLES_TENDON' 'TENSION' 'IMPULSE_PER_EVENT' 'TENDON_FORCE_TIME_INTEGRAL|MODELED_TENDON_STRESS_TIME_INTEGRAL' "$i|UNNORMALIZED_SOURCE_VALUE"
Add-Dimension 'ACH_TENSION_LOADING_RATE' 'TENDON' 'ACHILLES_TENDON' 'TENSION' 'LOADING_RATE' 'MODELED_TENDON_FORCE_LOADING_RATE|MODELED_TENDON_STRESS_LOADING_RATE' "$r|UNNORMALIZED_SOURCE_VALUE" 'SOURCE_OBSERVED' '' 'true' 'false' 'LOADING_RATE'
...
foreach ($tissue in @('PATELLAR_TENDON','QUADRICEPS_TENDON')) {
    ...
    Add-Dimension "${prefix}_TENSION_PEAK" 'TENDON' $tissue 'TENSION' 'PEAK' 'MODELED_TENDON_FORCE|MODELED_TENDON_STRESS|MEASURED_TENDON_STRAIN' "$f|MEASURED_TENDON_STRAIN_PERCENT|UNNORMALIZED_SOURCE_VALUE" 'SOURCE_OBSERVED' '' 'true' 'false' 'PEAK_TENSILE_LOAD|TENDON_STRAIN'
    Add-Dimension "${prefix}_TENSION_IMPULSE_EVENT" 'TENDON' $tissue 'TENSION' 'IMPULSE_PER_EVENT' 'TENDON_FORCE_TIME_INTEGRAL|MODELED_TENDON_STRESS_TIME_INTEGRAL' "$i|UNNORMALIZED_SOURCE_VALUE"
    Add-Dimension "${prefix}_TENSION_LOADING_RATE" 'TENDON' $tissue 'TENSION' 'LOADING_RATE' 'MODELED_TENDON_FORCE_LOADING_RATE|MODELED_TENDON_STRESS_LOADING_RATE' "$r|UNNORMALIZED_SOURCE_VALUE" 'SOURCE_OBSERVED' '' 'true' 'false' 'LOADING_RATE'
...
$ligNorm='ABSOLUTE_FORCE_NEWTON|MEASURED_LIGAMENT_STRAIN_PERCENT|BODY_MASS_NORMALIZED_JOINT_MOMENT|UNNORMALIZED_SOURCE_VALUE'
...
Add-Dimension 'ACL_IMPACT_PEAK' 'LIGAMENT' 'KNEE_ACL' 'IMPACT_STABILIZATION' 'PEAK' 'MEASURED_LIGAMENT_STRAIN' 'MEASURED_LIGAMENT_STRAIN_PERCENT|UNNORMALIZED_SOURCE_VALUE' 'SOURCE_OBSERVED' '' 'false' 'false' 'IMPACT_STABILIZATION'
...
Add-Dimension 'SUBTALAR_ROTATIONAL_PEAK' 'JOINT' 'ANKLE_SUBTALAR' 'ROTATIONAL_STRESS' 'PEAK' 'MODELED_JOINT_CONTACT_FORCE|EXTERNAL_JOINT_MOMENT|SOURCE_DEFINED_KINEMATIC_STABILITY_PROXY' "$f|BODY_MASS_NORMALIZED_JOINT_MOMENT|UNNORMALIZED_SOURCE_VALUE"
Add-Dimension 'ANKLE_LATERAL_INVERSION_PEAK' 'LIGAMENT' 'ANKLE_LATERAL_LIGAMENT_COMPLEX' 'INVERSION_STRESS' 'PEAK' 'MODELED_LIGAMENT_FORCE|MEASURED_LIGAMENT_STRAIN|EXTERNAL_JOINT_MOMENT|SOURCE_DEFINED_KINEMATIC_STABILITY_PROXY' $ligNorm 'SOURCE_OBSERVED' '' 'false' 'false' 'INVERSION'
