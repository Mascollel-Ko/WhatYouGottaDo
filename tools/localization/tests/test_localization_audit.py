...
class LocalizationAuditTest(unittest.TestCase):
    ...
    def test_current_baseline_has_locale_aware_routes(self):
        ...
        self.assertEqual(253, metrics["localizedExerciseNameCount"])
        self.assertEqual(253, metrics["localizedExerciseDescriptionCount"])
        self.assertEqual(12, metrics["localizedSeedProgramNameCount"])
        self.assertEqual(11, metrics["historyOnlyExerciseNameCount"])
